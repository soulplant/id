...
import com.id.app.EditorSwapperPanel;
...
public class EditorSwapperView extends EditorSwapperPanel implements ListModel.Listener<Editor> {
  private final Map<Editor, EditorPanel> map = new HashMap<Editor, EditorPanel>();

  public EditorSwapperView(ListModel<Editor> editors) {
  }
