...
DEFAULT_REVIEW_SERVER = "codereview.macadamiastudios.com"
...
def GetEmail(prompt):
  ...
  """
  last_email_file_name = os.path.expanduser("~/.last_codereview_email_address_macadamiastudios")
  last_email = ""
...
class HttpRpcServer(AbstractRpcServer):
  ...
  def _GetOpener(self):
    ...
    if self.save_cookies:
      self.cookie_file = os.path.expanduser("~/.codereview_upload_cookies_macadamiastudios")
...
def RealMain(argv, data=None):
  ...
  # NOTE(ray): Added to automatically CC everyone
  DEVS_EMAIL = 'dc-editor@googlegroups.com'
  if options.cc:
